...
namespace CourseManagament
{
    public partial class Frm_AddProgram : Form
    {
        ...
        private void Btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            programCode = int.TryParse(txt_ProgramCode.Text, out var tempProgramCode) ? tempProgramCode : 0;
            programCapacity = int.TryParse(txt_ProgramCapacity.Text, out var tempProgramCapacity) ? tempProgramCapacity : 0;

            FirstYear_1stSem = double.TryParse(TxtBox_1stYear_1stSem.Text, out var tempFirstYear1stSem) ? tempFirstYear1stSem : 0.0;
            FirstYear_2ndSem = double.TryParse(TxtBox_1stYear_2ndSem.Text, out var tempFirstYear2ndSem) ? tempFirstYear2ndSem : 0.0;

            SecondYear_1stSem = double.TryParse(TxtBox_2ndYear_1stSem.Text, out var tempSecondYear1stSem) ? tempSecondYear1stSem : 0.0;
            SecondYear_2ndSem = double.TryParse(TxtBox_2ndYear_2ndSem.Text, out var tempSecondYear2ndSem) ? tempSecondYear2ndSem : 0.0;

            ThirdYear_1stSem = double.TryParse(TxtBox_3rdYear_1stSem.Text, out var tempThirdYear1stSem) ? tempThirdYear1stSem : 0.0;
            ThirdYear_2ndSem = double.TryParse(TxtBox_3rdYear_2ndSem.Text, out var tempThirdYear2ndSem) ? tempThirdYear2ndSem : 0.0;

            FourthYear_1stSem = double.TryParse(TxtBox_4thYear_1stSem.Text, out var tempFourthYear1stSem) ? tempFourthYear1stSem : 0.0;
            FourthYear_2ndSem = double.TryParse(TxtBox_4thYear_2ndSem.Text, out var tempFourthYear2ndSem) ? tempFourthYear2ndSem : 0.0;
